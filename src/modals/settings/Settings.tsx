        ...
        >
            <div className="flex items-center justify-center">
                ...
                <svg
                    ...
                    viewBox="0 0 24 24" 
                    className="size-[36px] lg:size-[48px] 2xl:size-[56px] fill-gray-900 mr-2 shrink-0 transition-[fill_width_height] duration-350 dark:fill-white"
                >
                ...
                <p className="text-2xl lg:text-3xl 2xl:text-4xl pb-1 [transition:font-size_350ms,color_350ms] font-bold line-clamp-1 dark:text-white">{t('settings.header')}</p>
            </div>
            <ul className="space-y-4 px-5 pt-4 pb-2 [transition:padding_350ms]">
                    ...
                    >
                        <div className="flex items-center border-b-1 p-2 transition-[border-color] duration-350 border-gray-300 dark:border-gray-500">
                            ...
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24" 
                                className={`size-[28px] lg:size-[36px] 2xl:size-[44px] fill-gray-300 mr-2 shrink-0 transition-[fill_width] duration-350 dark:fill-white`}
                            >
                            ...
                            <p className="text-xl lg:text-2xl 2xl:text-3xl  [transition:font-size_350ms,color_350ms] font-semibold line-clamp-1 font-mono text-gray-300 dark:text-white">{t('settings.darkModeHeader')}</p>
                        </div>
                        <div className="p-2 min-h-[120px]">
                            <p className="text-left text-base lg:text-lg 2xl:text-xl  [transition:font-size_350ms,color_350ms] text-gray-300 dark:text-white">{t('settings.darkModeText')}</p>
                        </div>
                    </button>
                </li>
                    ...
                    >
                        <div className={`flex items-center border-b-1 p-2 transition-[border-color] duration-350 ${chooseLocationOnClick ? 'border-white dark:border-gray-500' : 'border-gray-300 dark:border-gray-600'}`}>
                            ...
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24" 
                                className={`size-[28px] lg:size-[36px] 2xl:size-[44px] mr-2 shrink-0 transition-[fill_width] duration-350 ${chooseLocationOnClick ? 'fill-white' : 'fill-gray-300 dark:fill-gray-600'}`}
                            >
                            ...
                            <p className={`text-xl lg:text-2xl 2xl:text-3xl [transition:font-size_350ms,color_350ms] font-semibold line-clamp-1 font-mono ${chooseLocationOnClick ? 'text-white' : 'text-gray-300 dark:text-gray-600'}`}>{t('settings.forecastOnClickHeader')}</p>
                        </div>
                        <div className="p-2 min-h-[120px]">
                            <p className={`text-left text-base lg:text-lg 2xl:text-xl [transition:font-size_350ms,color_350ms] ${chooseLocationOnClick ? 'text-white' : 'text-gray-300 dark:text-gray-600'}`}>{t('settings.forecastOnClickText')}</p>
                        </div>
                    </button>
                </li>
                ...
                <li>
                    <button 
                        className={`w-full rounded-lg shadow-md border-1 transition-[background-color,border-color,outline-width] duration-[350ms,350ms,0ms] bg-sky-300 border-gray-400 hover:bg-sky-400 active:bg-sky-200 hover:cursor-pointer focus-visible:outline-2 focus-visible:outline-slate-600 dark:bg-gray-600 dark:hover:bg-gray-700 dark:active:bg-gray-900 dark:focus-visible:outline-slate-300`}
                        onClick={() => {
                    ...
                    >
                        <div className="flex items-center border-b-1 p-2 border-white dark:border-gray-500 [transition:border-color_350ms]">
                            <p className="text-2xl lg:text-3xl 2xl:text-4xl font-bold line-clamp-1 font-mono text-white uppercase mr-2 bg-sky-500 shadow-sm px-1 lg:p-1 rounded-full [transition:background-color_350ms,font-size_350ms,padding_350ms] dark:bg-sky-600">{i18n.language}</p>
                            <p className="text-xl lg:text-2xl 2xl:text-3xl [transition:font-size_350ms] font-semibold line-clamp-1 font-mono text-white">{t('settings.languageHeader')}</p>
                        </div>
                        <div className="p-2 min-h-[120px]">
                            <p className="text-left text-base lg:text-lg 2xl:text-xl [transition:font-size_350ms] text-white">{t('settings.languageText')}</p>
                        </div>
                    </button>
                </li>
